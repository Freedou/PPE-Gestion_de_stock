...
public class User
{
	...
	public User(int id, String raison_social, String nom, String prenom, String mail, String password, String fadresse1, String fadresse2, String fcp, String fville, String ladresse1, String ladresse2, String lcp, String lville, boolean admin, boolean gestionnaire, int nb_commande)
	{
		this.id = id;
